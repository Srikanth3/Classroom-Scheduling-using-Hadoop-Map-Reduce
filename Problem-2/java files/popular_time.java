					...
					throws IOException, InterruptedException 
			{
				...
				try
				{
					...
					else 
					{
						hall = hall.trim();
						days=days.trim();
						if (time.equalsIgnoreCase("unknown")|| days.equalsIgnoreCase("UNKWN")  || hall.equalsIgnoreCase("UNKWN") || days.equalsIgnoreCase("ARR") || days.equalsIgnoreCase("Unknown")|| hall.equalsIgnoreCase("Unknown") || hall.equalsIgnoreCase("Arr")) 
						{
							return;
						}
					}
